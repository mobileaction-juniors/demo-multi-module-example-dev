...
public class UserRequestHandlerServiceTests
{
    ...
    void setUp()
    {
        requestHandlerService = new UserRequestHandlerService(userResultQueueTemplate, userRequestProblemQueueTemplate, crawlerClient);
    }
    ...
    public void test_executeMessage_fail()
    {
        ...
        doThrow(RuntimeException.class).when(crawlerClient).fetchUser(1L);
