...
public class UserRequestQueueHandler {
    ...
    //RabbitListener to listen to the user request queue and handle incoming messages asynchronously
    ...
    public void handleMessage(UserQueueRequestDto request) {
        try {
            ...
            //sending the failed request to the problem queue for further analysis and troubleshooting
