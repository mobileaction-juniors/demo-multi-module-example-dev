...
public class AdminController
{
    ...
    public ResponseEntity<Boolean> createPostsQueueRequests()
    {
    ...
    public ResponseEntity<Boolean> createUsersQueueRequests()
    {
        userQueueService.sendPostRequestForAllUsers();
