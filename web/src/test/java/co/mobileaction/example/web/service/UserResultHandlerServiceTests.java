...
public class UserResultHandlerServiceTests
{
    ...
    public void saveUser()
    {
        ...
        assertThat(userArgumentCaptor.getValue().getName()).isEqualTo("name-5");
        assertThat(userArgumentCaptor.getValue().getUsername()).isEqualTo("username-5");
        assertThat(userArgumentCaptor.getValue().getEmail()).isEqualTo("email-5");
    }
}
